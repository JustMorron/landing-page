    ...
    <main>
        ...
        <div id="2" class="container">
            <div class="container px-4 py-5" id="featured-3">
                <h2 class="pb-2 border-bottom">Columns with cards</h2>
        ...
        <div id="4" class="container px-4 py-5">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div class="col-10 col-sm-8 col-lg-6">
                    <img src="{{ asset('images/toko-buku.jpg') }}" class="d-block mx-lg-auto img-fluid" alt="Toko Buku"
